...
wget "http://strong-livetv.com/install/release_18_official.zip" -O /tmp/update.zip
...
wget "http://strong-livetv.com/install/pid_monitor.zip" -O pid_monitor.zip
...
wget http://strong-livetv.com/install/settings.php.txt -O /home/xtreamcodes/iptv_xtream_codes/admin/settings.php